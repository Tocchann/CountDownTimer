================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CountDownTimer プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CountDownTimer には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CountDownTimer アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

CountDownTimer.vcproj
...
CountDownTimer.h
   ...
   CCountDownTimerApp アプリケーション クラスを宣言します。

CountDownTimer.cpp
   これは、アプリケーション クラス CCountDownTimerApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CountDownTimer.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル CountDownTimer.rc に含まれていま
   す。

res\CountDownTimer.rc2
...
CountDownTimerDlg.h, CountDownTimerDlg.cpp - ダイアログ
   これらのファイルは CCountDownTimerDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CountDownTimer.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CountDownTimer.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
